  ...
  return (
    <div>
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
          ...
          >
            ...
            <CardBody className="mb-6 p-0">
              <Typography>
                ...
                passionate voices connecting our organization with the
                community. They spread awareness, build relationships, and
                inspire others to get involved, creating a stronger, more
        ...
        {/* card-2 */}
        <Zoom duration={2000} delay={800} className="h-full">
          <Card
            color="transparent"
            shadow={false}
            className="w-full  border p-5 hover:shadow-lg duration-300"
          >
            <CardHeader
              ...
              floated={false}
              shadow={false}
              className="mx-0 flex items-center gap-4 pt-0 pb-8 h-full"
            >
              <Avatar
                size="lg"
                variant="circular"
            ...
            <CardBody className="mb-6 p-0">
              <Typography>
                ...
                behind expanding our reach and impact. You lead efforts to
                connect with communities, build partnerships, and spread
                awareness, ensuring our mission reaches those who need it
                most.&quot;
              </Typography>
            </CardBody>
          </Card>
          ...
          >
            ...
            <CardBody className="mb-6 p-0">
              <Typography>
                ...
                experiences that bring our community together. From conception
                to execution, you handle every detail, ensuring seamless events
                that inspire, educate, and unite us toward our shared
                goals.&quot;
              </Typography>
            </CardBody>
          </Card>
          ...
          >
            ...
            <CardBody className="mb-6 p-0">
              <Typography>
                ...
                volunteer program. You recruit, train, and support our
                volunteers, matching their skills and passions with
                opportunities that drive our mission forward. Your dedication
                ensures our volunteers feel valued and empowered, creating a
                vibrant community of change-makers.&quot;
              </Typography>
            </CardBody>
          </Card>
        </Zoom>
