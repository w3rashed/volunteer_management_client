  ...
  return (
    <div className="mt-20 ">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-10">
        <Card color="transparent" className=" hover:shadow-lg duration-300">
          <CardHeader
            color="transparent"
            floated={false}
        ...
        <Card color="transparent" className=" hover:shadow-lg duration-300">
          ...
          <CardBody className="text-center">
            ...
            <Typography color="blue-gray" className="font-medium" textGradient>
              ...
              hygiene education, we aim to provide clean, safe water to those in
              need. Join us in ensuring everyone has access to this fundamental
              resource.
            </Typography>
          </CardBody>
        </Card>
        ...
        <Card color="transparent" className=" hover:shadow-lg duration-300">
          ...
          <CardBody className="text-center">
            ...
            <Typography color="blue-gray" className="font-medium" textGradient>
              Our campaign is dedicated to ensuring that every child has access
              to quality education. Through advocacy, fundraising, and community
              partnerships, we strive to remove barriers to learning and provide
              opportunities for children worldwide to reach their full
              potential. Join us in building a brighter future for all.
            </Typography>
          </CardBody>
        </Card>
      </div>
